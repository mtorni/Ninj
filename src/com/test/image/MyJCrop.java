...
public class MyJCrop {

	String sourceDirPath = "";
	String targetDirPath = "";

	public MyJCrop(String sourceDirPath, String targetDirPath) {
	...
	public void cropImage(URL u, String targetFileName, int x, int y, int w,
			int h) {
	...
	public void cropImageForDB(URL u, int x, int y,
			int w, int h) {
	...
	public void cropImage(byte[] ba, String targetFileName, int x, int y,
			int w, int h) {
		...
		try {
			...
			Image image = new ImageIcon(ba).getImage();
			BufferedImage outImage = toBufferedImage(image);
			BufferedImage img = outImage.getSubimage(x, y, w, h);
			ImageIO.write(img, "jpg", tempFile);
			tmp.close();
	...
	public void cropImage(String sourceFileName, String targetFileName, int x,
			int y, int w, int h) {
